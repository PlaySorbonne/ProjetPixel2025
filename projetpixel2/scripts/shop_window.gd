...
@onready var tower_shop_item := $Contents/ScrollBoxItems/HBoxContainer/VBoxItems/ButtonTower
...
func _ready() -> void:
	...
	# initialize prices
	var shop_item_buttons : Array[ShopItemButton] = get_shop_items(true)
	var item_index := 0
